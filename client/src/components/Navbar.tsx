...
import { Menu, Bell, User, Plane, Crown, Star, DollarSign, LogOut, Settings, ChevronDown, Car, Calendar, FileText, Wallet, BookOpen, Languages, Bed, AlertTriangle } from "lucide-react";
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: <AlertTriangle className="w-4 h-4" />, path: "/travel-alerts" },
